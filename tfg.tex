...
% Gaspar Perez Scornik <gasparperez2010@gmail.com>
%
...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \item First of all, \( V^X \) is an \( R \)-module in an obvious way. Let \( f:D\to V^X \) be a function. This defines, for each \( x\in X \), a function \( g(x):D\to V \) by
    \[
      d\mapsto f(d)(x)
    \]
